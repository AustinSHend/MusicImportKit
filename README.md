![Main window](https://i.imgur.com/e1JeNvj.png)
...
* Robust codebase, currently tested on **119** albums of all shapes and sizes (including a few [witch.house](https://i.imgur.com/lBUJZfz.png) albums for good measure). All features have been double and triple-checked against proper traditional methods to make sure the output files match.
...
* [exiftool.exe](https://www.sno.phy.queensu.ca/~phil/exiftool/)
    * Strip image metadata from images that are copied from temp to output
